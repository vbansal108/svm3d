...
public class XValDemo {
	...
	public static void regressionTrial(String name) throws IOException{
		...
		XValResult r = svm.xval(inputs.getX(), inputs.getY(), p, 3, new Range(0, 10000), 6, new Range(0, 5), 6);	
		...
		// Reload and apply
		svm = new RegressionSVM(LibSvmIO.DIR_MODELS + name + "/model.lsvm"); // TODO: does not reload params correctly
